...
void handleRoot(){
  ...
  message += "modeInit(mode1, 'blinking', 'Blinking', 1);";
  message += "modeInit(mode2, 'fading', 'Fading', 2);";
  message += "let modeArray = [mode1, mode2];";
  ...
  message += "Gcolor = Math.sin(colorVal2) * 255; if(Gcolor < 0) Gcolor = 0;";
  message += "Bcolor = Math.sin(colorVal2 + 3 * Math.PI / 2) * 255; if(Bcolor <  0) Bcolor = 0;";
  message += "}";
